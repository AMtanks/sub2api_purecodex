export default {
  ...
  customPage: {
    ...
    officialStatus: {
      ...
      activeIncidentsSection: '活动事件',
      servicesSection: '服务列表',
      activeIncidentsHint: '以下为官方仍在处理中的事件。',
      componentBarsHint: '以下色条表示各组件当前状态，不代表官方历史 uptime 统计。',
      loadFailedTitle: '状态获取失败',
