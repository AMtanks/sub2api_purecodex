export default {
  ...
  customPage: {
    ...
    officialStatus: {
      ...
      subtitle: 'This page reads the OpenAI public status API directly and renders it locally instead of using an iframe.',
      refresh: 'Refresh',
      ...
      activeIncidentsSection: 'Active incidents',
      servicesSection: 'Services',
      activeIncidentsHint: 'These are the incidents still active on the official status page.',
      componentBarsHint: 'The bars below show current component states only, not the official historical uptime chart.',
      loadFailedTitle: 'Failed to load status',
      ...
      lastUpdated: 'Official update time {time}',
